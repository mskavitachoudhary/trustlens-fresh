...
PRODUCT_SEED = [
    ...
    },
    {
        ...
        "intended_use": "Antiseptic and disinfectant liquid for first aid, personal hygiene, and surface disinfection.",
        "consumption_status": "Not intended for human consumption",
        "manufacturer": "Reckitt Benckiser",
        "market": "India",
        "barcode": "8901396000010",
        "product_type": "physical",
        "description": "Dettol Antiseptic Disinfectant Liquid provides protection against germs and illness-causing bacteria.",
        "country": "India",
        "gtin": "8901396000010",
        "edible_status": "non_edible",
        "external_use_status": True,
        ...
        "source_date": "2026-08",
        "ingredients": [
            ("ING-CHLOROXYLENOL", 4.8, "%", "active antiseptic"),
            ("ING-PINE-OIL", 9.2, "%", "antiseptic / fragrance"),
            ("ING-ISOPROPYL-ALCOHOL", 5.1, "%", "solvent / antiseptic"),
            ("ING-CASTOR-OIL", None, None, "emollient"),
            ("ING-POTASSIUM-CASTORATE", None, None, "soap base / surfactant"),
            ("ING-WATER", None, None, "solvent"),
        ],
        "identifiers": [
            {"identifier_type": "gtin", "identifier_value": "8901396000010", "source": "Product label"},
        ],
        "attributes": [
            {"attribute_name": "Volume", "attribute_value": "550 ml", "attribute_type": "text"},
            {"attribute_name": "Active Ingredient", "attribute_value": "Chloroxylenol 4.8% w/v", "attribute_type": "text"},
        ],
    },
    # ===== ELECTRONICS =====
    {
